...
cv2.imwrite('../models/pso_opencv/gray_mean1.jpg', gray_mean1)
cv2.imwrite('../models/pso_opencv/gray_weighted1.jpg', gray_weighted1)
cv2.imwrite('../models/pso_opencv/gray_mean2.jpg', gray_mean2)
cv2.imwrite('../models/pso_opencv/gray_weighted2.jpg', gray_weighted2)